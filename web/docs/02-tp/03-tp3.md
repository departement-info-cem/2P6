...
- [ ] **Partie 5 :** Compléter la classe `Quiz` fournie **(15%)**
- [ ] **Partie 6 :** Écrire des tests unitaires pour la classe `Quiz` **(20%)**
- [ ] **Partie 7 :** Adapter le formulaire (0 point – requis)
...
👉 **Important :**  
La partie 1 n’est pas bloquante. Elle permet d’améliorer le modèle proposé afin d’obtenir tous les points.
...
Cela permet :
- de rendre le formulaire partiellement fonctionnel (questions Vrai/Faux) ;
...
## 💻 Partie 3 – Implémentation du diagramme (20 points)
...
* [ ] L’énoncé ne doit pas être **null, vide ou composé uniquement d’espaces**
* [ ] Le nombre de points doit être **strictement supérieur à 0**
* [ ] La liste des options ne doit pas être **null**
* [ ] La liste d'options doit contenir **au moins deux options**
* [ ] La bonne réponse ne doit pas être **null ou vide**
* [ ] La bonne réponse doit **faire partie des options**
* [ ] La liste des bonnes réponses ne doit pas être **null**
* [ ] La liste des bonnes réponses ne doit pas être doit contenir **au moins une réponse**
* [ ] Chaque bonne réponse doit être **non vide**
* [ ] Chaque bonne réponse doit être **présente dans les options**
* [ ] L’indice ne doit pas être **null ou vide**
* [ ] La pénalité doit être **comprise entre 0 et 1**

Dans tous les cas de validation, vous devez lever une **exception appropriée** (ex : ArgumentException, ArgumentNullException, etc.) avec un message clair et explicite.
...
## 🗂️ Partie 5 - Compléter la classe Quiz fournie (15%)
...
## 🖥️ Partie 7 – Adapter le formulaire (0 point – requis)
...
Un formulaire fonctionnel vous est fourni. Il permet actuellement de gérer uniquement les questions de type **Vrai/Faux**.

Votre travail consiste à compléter ce formulaire afin de le rendre compatible avec tous les types de questions définis dans le modèle.

Vous devez notamment :

- analyser le code déjà fourni dans le formulaire ;
- décommenter les sections pertinentes lorsque les éléments du modèle sont implémentés ;
- adapter le code du formulaire à votre solution au besoin ;
- vous assurer que le formulaire fonctionne avec les différents types de questions ;


:::info
- Le formulaire contient déjà plusieurs sections de code prévues pour les différents types de questions.  
- Certaines lignes sont commentées, car elles dépendent d’éléments que vous devez implémenter dans le modèle.

Votre travail consiste donc principalement à décommenter, compléter ou adapter ce code afin qu’il fonctionne avec votre solution.
:::
