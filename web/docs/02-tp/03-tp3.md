...
- [ ] **Partie 2 :** Améliorer le diagramme de classes **(15%)**
- [ ] **Partie 3 :** Implémenter le diagramme de classes **(15%)**
...
## 💻 Partie 3 – Implémentation du diagramme (15 points)
...
Dans cette partie, un formulaire vous est fourni. Cependant, certaines fonctionnalités sont incomplètes et doivent être implémentées.

Vous devez donc compléter le formulaire afin de permettre à l’utilisateur d’interagir correctement avec le quiz.
...
:::info
La structure générale du formulaire est déjà fournie afin de vous guider.
:::
...
:::warning
- Le formulaire doit utiliser la classe `Quiz` pour gérer la logique du quiz et la classe `BanqueQuestions` pour générer un quiz.
- La logique principale ne doit pas être codée directement dans l’interface.
- Il est interdit aussi de créer ou manipuler directement les questions dans le formulaire.
:::
